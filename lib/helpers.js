...
/**
* Simple equality helper for Handlebars`
*/
...
/**
* Simple not-equality helper for Handlebars`
*/
function ne(input1, input2) {
  return input1 !== input2; // eslint-disable-line eqeqeq
}
...
function ensureJobTmpDirExists(jobId, callback) {
  ...
  fs.access(targetPath, fs.constants.F_OK | fs.constants.W_OK, (accessTmpDirErr) => {
    ...
    return fs.mkdir(targetPath, { recursive: true }, (mkdirErr) => {
      if (mkdirErr) {
